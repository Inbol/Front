...
const estilos = {
  ...
  terciario:
    "bg-secondary-500 hover:bg-secondary-700 text-white font-bold py-2 px-4 rounded cursor-pointer hover:scale-105",
  cancel:
...
const CustomButton = ({
  ...
  const clase = `${estilos[style] || estilos.primario} ${extraClases}`;
